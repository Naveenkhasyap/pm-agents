...
class Prompter:
    ...
    def prompts_polymarket_with_news(
    ...
    def prompts_polymarket_with_news1(
        ...
        Offer a final prediction statement in the following format:

        "There is a [X]% probability that {market_question} will occur, and a [Y]% chance that it will not."
        ...
        question=`{market_question}` with relevant news headlines=`{current_news_titles}` combination. 
        ...
        Give your detailed response with probabilities for each binary outcome.
        """
